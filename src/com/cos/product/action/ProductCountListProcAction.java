...
public class ProductCountListProcAction implements Action {
	private static final String TAG = "ProductCountListProcAction : ";
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Product> products = productRepository.findAllCount();
